...
function getBotResponse(
  ...
  if (/who|about|apollon|aboubacar|yourself|qui est|c'est qui|présente/.test(i))
    return isFR
      ? { text: 'Aboubacar Sidick Meite (alias ApollonIUGB77) est un étudiant en M.S. Cybersecurity à Montclair State University, New Jersey. Chercheur en sécurité, joueur CTF et développeur full-stack spécialisé en cryptographie et hacking éthique. 🇨🇮→🇺🇸' }
      : { text: 'Aboubacar Sidick Meite (aka ApollonIUGB77) is a cybersecurity grad student at Montclair State University, NJ. Security researcher, CTF player, and full-stack dev specializing in cryptography and ethical hacking. 🇨🇮→🇺🇸' };
