...
const LINKS = [
  ...
  { icon: <GitFork className="w-5 h-5" />, label: 'GitHub',     value: '@ApollonIUGB77',          sub: 'Open-source projects',  href: 'https://github.com/ApollonIUGB77',                          color: '#e2e8f0' },
  { icon: <Shield className="w-5 h-5" />, label: 'TryHackMe',  value: 'exterminator',            sub: '[0xA] WIZARD — Top 4%', href: 'https://tryhackme.com/p/exterminator',                      color: '#00d4ff' },
